 ...
 *
 * All DecimaMarioGallegos code is copyright by the original authors and released under the GNU Aferro General Public License version 3 (AGPLv3) or later.
 * See COPYRIGHT and LICENSE.
 */
namespace Mgallegos\DecimaMarioGallegos\MarioGallegos\Seeders;

use DB;
use App\Kwaai\Security\MarioGallegos;
...
class MenuTableSeeder extends Seeder {
	...
	public function run()
	{
		MarioGallegos::create(array('name' => 'Decima MarioGallegos', 'lang_key' => 'decima-module::menu.module', 'icon' => 'fa fa-calculator', 'created_by' => 1));
		$moduleId = DB::table('SEC_MarioGallegos')->max('id');

<div id="lqp-main">
  <div id="lqp-doc-title" class="clearfix">
    <div class="pull-left">
      <h1 class="lqp-header">
  ...
  <div id='lqp-code-0' class="well well-sm lqp-well">"mgallegos/laravel-jqgrid": "1.*"</div>
  ...
  <div id='lqp-code-1' class="well well-sm lqp-well">'Mgallegos\LaravelJqgrid\LaravelJqgridServiceProvider',</div>
  ...
  <div id='lqp-code-2' class="well well-sm lqp-well">'GridRender' => 'Mgallegos\LaravelJqgrid\Facades\GridRender',<br>'GridEncoder' => 'Mgallegos\LaravelJqgrid\Facades\GridEncoder',</div>
  ...
  <div id='lqp-code-3' class="well well-sm lqp-well">php artisan vendor:publish --provider="Mgallegos\LaravelJqgrid\LaravelJqgridServiceProvider"</div>
  <p>And on Laravel 4:</p>
  <div class="zero-clipboard">
    <span class="btn-clipboard" data-clipboard-target="lqp-code-3a">Copy</span>
  </div>
  <div id='lqp-code-3a' class="well well-sm lqp-well">php artisan config:publish mgallegos/laravel-jqgrid/</div>
  ...
  <pre id='lqp-code-4a' class="prettyprint linenums:1">@include('oss-dev/laravel-jqgrid/example1a')</pre>
  ...
  <pre id='lqp-code-4b' class="prettyprint linenums:1">@include('oss-dev/laravel-jqgrid/example1b')</pre>
  <div class="alert alert-info" role="alert">
  ...
  <img src="{{ URL::asset('assets/kwaai/images/laravel-jqgrid/XLS.png') }}" class="pull-left img-responsive" style="margin-right: 5px">
  ...
  <pre id="lqp-code-4c" class="prettyprint linenums:1">@include('oss-dev/laravel-jqgrid/example1c')</pre>
  ...
  <pre id='lqp-code-5' class="prettyprint linenums:1">@include('oss-dev/laravel-jqgrid/example2')</pre>
  ...
  <pre id='lqp-code-6' class="prettyprint linenums:1">@include('oss-dev/laravel-jqgrid/example3')</pre>
  ...
  <pre id='lqp-code-7' class="prettyprint linenums:1">@include('oss-dev/laravel-jqgrid/example4')</pre>
  ...
  <pre id='lqp-code-8' class="prettyprint linenums:1">@include('oss-dev/laravel-jqgrid/example5')</pre>
  <div class="hidden-lg" style="margin-bottom: 5px;">
      <!-- Blog Post -->
      <ins class="adsbygoogle"
           style="display:block"
  ...
  <ul>
    ...
    <li>Tree-Grid implementation.</li>

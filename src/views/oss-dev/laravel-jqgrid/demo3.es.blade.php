  ...
  <div id="lqp-btn-group-1" class="btn-group">
    ...
    <div class="btn-group">
       ...
       <ul class="dropdown-menu">
         <li><a id='lqp-export-xls' class="fake-link"><i class="fa fa-file-excel-o"></i> xls</a></li>
         <li><a id='lqp-export-csv' class="fake-link"><i class="fa fa-file-text-o"></i> csv</a></li>
       </ul>
    </div>
  </div>
...
<div id="lqp-grid-section" class="app-grid collapse in">
{!!
  ...
  <div class="form-container">
    {!! Form::open(array('id' => 'lqp-book-form', 'url' => URL::to('/cms/open-source-development/laravel-jqgrid'), 'role' => 'form', 'class' => 'form-horizontal', 'onsubmit' => 'return false;')) !!}
      <fieldset id="lqp-books-form-fieldset">
        <legend id="lqp-form-new-title" class="hidden">Add a new book</legend>
				<legend id="lqp-form-edit-title" class="hidden">Edit an existing book</legend>
...
<script type='text/javascript'>
  ...
  $('#lqp-btn-new').click(function()
  {
    ...
    $('#lqp-form-new-title').removeClass('hidden');
  ...
  $('#lqp-btn-edit').click(function()
  {
    ...
    $('#lqp-btn-group-3').enableButtonGroup();
    //Shows the form title.
    $('#lqp-form-edit-title').removeClass('hidden');
    //Manually hide the tooltips (fix for firefox).
    $('.lqp-tooltip').tooltip('hide');
    //This is a bootstrap javascript effect to hide the grid.
    $('#lqp-grid-section').collapse('hide');
  ...
  $('#lqp-btn-close').click(function()
  {
    ...
    $('#lqp-form-new-title').addClass('hidden');
    $('#lqp-form-edit-title').addClass('hidden');
    //Manually hide the tooltips (fix for firefox).
    $('.lqp-tooltip').tooltip('hide');
